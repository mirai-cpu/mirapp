...
const FIELD_ZONES = [
  ...
  // Outfield zones (lf+lc merged → lf; rc+rf merged → rf; cf same)
  { id: 'lf', path: 'M83,188 A95,95 0 0 1 135,161 L114,28 A230,230 0 0 0 5,92 Z',    cx: 55,  cy: 108 },
  { id: 'cf', path: 'M135,161 A95,95 0 0 1 165,161 L186,28 A230,230 0 0 0 114,28 Z', cx: 150, cy: 83  },
  { id: 'rf', path: 'M165,161 A95,95 0 0 1 217,188 L295,92 A230,230 0 0 0 186,28 Z', cx: 245, cy: 108 },
